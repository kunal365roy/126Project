...
if __name__ == '__main__':
    ...
    for key in sentiment_dict:
        sentiments_vector.append(sentiment_dict[key])
        popularity_vector.append(popularity_dict[key])
        team_vector.append(key)
    ...
    interesting_teams = set(['Jets', 'Patriots', 'Giants', 'Steelers', 'Rams', 'Cardinals'])
